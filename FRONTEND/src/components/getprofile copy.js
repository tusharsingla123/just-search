...
const Getprofile = () => {
    ...
    useEffect(() => {
        ...
        axios.post("//localhost:1000/getprofile", {
            t1: email,
        }).then((res) => {
            setData(res.data);
        });
                                            ...
                                            <div className="col-xl-4">
                                                <div className="card mb-4 mb-xl-0">
                                                    ...
                                                    <div className="card-body text-center">
                                                        <img className="img-account-profile rounded-circle mb-2" src={path} alt="Profile Image Here" />
                                            ...
                                            <form className="form-horizontal" action="">
                                                <div className="form-group">
                                                    ...
                                                    <div className="col-sm-10">
                                                        <input type="email" className="form-control" id="email" value={email_id} name="email" readOnly />
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <label className="control-label col-sm-2" for="name">FIRST NAME:</label>
                                                    <div className="col-md-4">
                                                        <input type="text" className="form-control" id="name" value={first_name} name="first name" />
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="col-md-4">
                                                        <input type="text" className="form-control" id="name" value={last_name} name="last name" />
                                                    </div>
                                                </div>
                                                {/* <div className="form-group">
                            ...
                            <select name="gender" id="gender" className="form-control">
                                ...
                                <option value="female">Female</option>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="col-sm-10">
                                                        <input type="text" className="form-control" id="category" value={category} name="category" />
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <label className="control-label col-sm-2" for="org">ORGANISATION NAME: </label>
                                                    <div className="col-sm-10">
                                                        <input type="text" className="form-control" id="org" value={org_name} name="organisation name" />
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <label className="control-label col-sm-2" for="ads">ADDRESS: </label>
                                                    <div className="col-sm-10">
                                                        <input type="text" className="form-control" id="ads" value={address} name="address" />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="col-sm-10">
                                                        <input type="text" className="form-control" id="state" value={state} name="state" />
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="col-sm-10">
                                                        <input type="text" className="form-control" id="city" value={city} name="city" />
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <label className="control-label col-sm-2" for="cn">CONTACT NUMBER: </label>
                                                    <div className="col-sm-10">
                                                        <input type="tel" className="form-control" id="cn" value={contactno} name="contact number" />
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <label className="control-label col-sm-2" for="cp">CONTACT PERSON: </label>
                                                    <div className="col-sm-10">
                                                        <input type="text" className="form-control" id="cp" value={contact_person} name="person name" />
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <label className="control-label col-sm-2" for="map">GOOGLE MAP LINK: </label>
                                                    <div className="col-sm-10">
                                                        <input type="text" className="form-control" id="map" value={gmap_link} name="map" />
                                                    </div>
                                                </div>
                                                {/* <div className="form-group">
